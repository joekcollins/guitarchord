...
def initialize_chord_dictionary():
    ...
    chord_formulas = {
        ...
        'min7♭5': [[0,3,6,10], [0,6,10]], # half diminished 7 variations (no dropping the fifth)
        ...
        'Maj7♭9':[[0,4,7,11,1], [0,4,11,1], [0,7,11,1]], # major 7 flat 9 variations
        'Maj7♯9':[[0,4,7,11,3], [0,4,11,3], [0,7,11,3]], # major 7 sharp 9 variations
        'dom7♭9':[[0,4,7,10,1], [0,4,10,1], [0,7,10,1]], # dominant 7 flat 9 variations
        ...
        'maj7♭9add11': [[0,4,7,11,1,5], [0,4,11,1,5],[0,7,11,1,5]], # major 7 flat nine add 11 variations
        'maj7♭9♯11': [[0,4,7,11,1,6], [0,4,11,1,6], [0,7,11,1,6]], # major 7 flat 9 sharp 11 variations
        'min11': [[0,3,7,10,2,5], [0,3,7,10,5], [0,3,7,2,5], # minor 7 add 11 variations
                  [0,3,10,2,5], [0,3,10,5], [0,3,7,5], [0,3,5],
                  [0,7,10,2,5], [0,7,10,5]],
        'min7♭9add11': [[0,3,7,10,1,5], [0,3,10,1,5], [0,7,10,1,5]], # minor 7 flat 9 add 11 variations
        'min7♯11':[[0,3,7,10,2,6], [0,3,10,2,6], [0,3,10,6], # minor 7 add sharp 11 variations
                   [0,3,7,10,6], [0,3,10,6]],
        'min7♭9♯11': [[0,3,7,10,1,6], [0,3,10,1,6],[0,7,10,1,6]], # minor 7 flat 9 sharp 11 variations
        ...
        'dom7♭9add11':[[0,4,7,10,1,6], [0,4,10,1,6], [0,7,10,1,6]], # dominant 7 flat 9 add 11 variations
        'dom7♭9♯11':[[0,4,7,10,1,6], [0,4,10,1,6]], # dominant 7 flat 9 sharp 11 variations
        'Maj13': [[0,4,7,11,2,5,9],    # 1–3–5–maj7–9–11–13
                  [0,4,7,11,2,9],     # omit 11
                  [0,4,7,11,5,9]],      # omit 9
        'Maj13♭9': [[0,4,7,11,1,5,9], [0,4,7,11,1,9]],  # flat9 variant
        'Maj13♯11': [[0,4,7,11,2,6,9], [0,4,7,11,6,9]],  # sharp11 variant
        'min13': [[0,3,7,10,2,5,9],   # 1–♭3–5–♭7–9–11–13
                  [0,3,7,10,2,9],     # omit 11
                  [0,3,7,10,5,9]],      # omit 9
        'min13♭9': [[0,3,7,10,1,5,9], [0,3,7,10,1,9]],
        'min13♯11': [[0,3,7,10,2,6,9], [0,3,7,10,6,9]],
        'dom13': [[0,4,7,10,2,5,9],   # 1–3–5–♭7–9–11–13
                  [0,4,7,10,2,9],     # omit 11
                  [0,4,7,10,5,9]],      # omit 9
        'dom13♭9': [[0,4,7,10,1,5,9], [0,4,7,10,1,9]],
        ...
        '7♭5':      [[0,4,6,10],     [0,6,10]],       # Dom7 with flat5
        '7♯5':      [[0,4,8,10],     [0,8,10]],       # Dom7 with sharp5
        '9♭5':      [[0,4,6,10,2],   [0,6,10,2]],     # 9th with flat5
        '9♯5':      [[0,4,8,10,2],   [0,8,10,2]],     # 9th with sharp5
        '11♭5':     [[0,4,6,10,2,5], [0,6,10,2,5]],   # 11th with flat5
        '11♯5':     [[0,4,8,10,2,5], [0,8,10,2,5]],   # 11th with sharp5
        '13♭5':     [[0,4,6,10,2,5,9], [0,6,10,2,5,9]],# 13th with flat5
        '13♯5':     [[0,4,8,10,2,5,9], [0,8,10,2,5,9]],# 13th with sharp5
        '7♭9':      [[0,4,7,10,1],   [0,4,10,1]],     # Dom7 flat9
        '7♯9':      [[0,4,7,10,3],   [0,4,10,3]],     # Dom7 sharp9
        '9♭9':      [[0,4,7,10,1,2], [0,4,7,10,1]],   # 9th flat9
        '9♯9':      [[0,4,7,10,3,2], [0,4,7,10,3]],   # 9th sharp9
        '11♭9':     [[0,4,7,10,1,2,5],  [0,4,7,10,1,5]],   # 11th flat9
        '11♯9':     [[0,4,7,10,3,2,5],  [0,4,7,10,3,5]],   # 11th sharp9
        '13♭9':     [[0,4,7,10,1,2,5,9],[0,4,7,10,1,5,9]], # 13th flat9
...
class FretboardGUI(tk.Tk):
    ...
    def _update_chord_label(self):
        ...
        note_string = ', '.join(display_notes)
        self.info_label.config(
            text=f"Notes: {note_string} → Chord: {chord_display}"
        )
